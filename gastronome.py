...
def UpdateDatabase():
    ...
    {"0":"Preheat oven to 450°F. Line a large baking sheet with parchment paper. Lightly coat with cooking spray.",
     "1":"Separate egg whites from the yolks, placing each yolk in an individual small bowl.",
     "2":"Beat all of the egg whites and salt in a mixing bowl with an electric mixer on high speed until stiff.",
     "3":"Gently fold Parmesan and scallions into the beaten whites with a rubber spatula. Make 4 mounds (about ¾ cup each) of egg-cheese mixture on the prepared baking sheet. Make a well in the middle of each mound with the back of a spoon.",               
    ...
    {"0":"Beat eggs with milk and salt in a small bowl. Heat 1 teaspoon oil in a small nonstick skillet over medium heat.",
     "1":"Add the egg mixture and cook until the bottom is set and the center is still a bit runny, 1 to 2 minutes.",
    ...
    {"0":"To prepare oatcakes: Whisk buttermilk (or kefir) and egg in a medium bowl. Combine oats, flour, sugar, baking soda, ½ teaspoon cinnamon and salt in another medium bowl.",
     "1":"Stir the dry mixture into the wet mixture and let stand for 15 minutes. The mixture will bubble slightly as it sits.",
     "2":"To prepare compote: Meanwhile, place raspberries, maple syrup and 1 teaspoon cinnamon in a small heavy saucepan. Bring to a simmer over medium heat and cook, stirring occasionally, until the berries are mostly broken down, 3 to 5 minutes.",
     "3":"Remove from heat and cover to keep warm.",
     "4":"Coat a griddle or large nonstick skillet with cooking spray; heat over medium heat. Using ¼ cup of batter for each, cook 3 oatcakes at a time until bubbles dot the surface, 2 to 3 minutes.",
    ...
    {"0":"Preheat oven to 425°F. Coat a large baking sheet with cooking spray.",
     ...
     "2":"Meanwhile, heat 1 tablespoon oil in a large saucepan over medium heat. Add garlic and cook, stirring, about 30 seconds.",
     "3":"Add spinach by the handful and cook, stirring, until wilted, about 5 minutes. Transfer to a colander; press out excess liquid.",
     "4":"Return the spinach to the pan and season with vinegar, ¼ teaspoon pepper and salt.",
     "5":"Cut a 3½-inch hole in the middle of each slice of bread. (Save the rounds for another use, if desired.)",
     "6":"Heat 1 tablespoon of the reserved bacon fat in the skillet over medium-high heat. Cook 2 slices of bread, pressing with a spatula, until lightly browned, 1 to 3 minutes per side. Transfer to the prepared baking sheet. Repeat with the remaining fat and bread.",
    ...
    {"0":"To prepare beans: Heat 1 tablespoon oil in a medium saucepan over medium heat. Add garlic and cumin seeds; cook, stirring, until fragrant and starting to brown, 30 seconds to 1 minute.",
     "1":"Stir in beans, lime juice and ¼ teaspoon salt and cook until hot, 2 to 4 minutes. Remove from heat and mash with a potato masher until mostly smooth.",
     "2":"Refrigerate ½ cup of the mashed beans for another use. Cover the remaining beans to keep warm.",
     "3":"To prepare chicken & vegetables: Position rack in upper third of oven; preheat broiler to high. Line a rimmed baking sheet with foil.",
     "4":"Toss scallions and bell peppers in a large bowl with 1½ tablespoons oil and ¼ teaspoon each salt and pepper. Transfer to the prepared baking sheet. Broil, stirring twice, until the vegetables are charred, 8 to 12 minutes.",
     "5":"Meanwhile, place chicken between 2 large pieces of plastic wrap. Pound with the smooth side of a meat mallet or a heavy saucepan to an even ½-inch thickness. Combine chile powder, cinnamon, cocoa, brown sugar and the remaining ½ teaspoon salt in a small bowl.",
    ...
    {"0":"Heat oil in a large nonstick skillet over medium-high heat. Add chicken and sprinkle with 1 teaspoon cumin and ¼ teaspoon salt. Cook, stirring occasionally, until the chicken is just cooked through, 5 to 7 minutes.",
     "1":"Transfer to a bowl and toss with cilantro. Cover to keep warm.",
     "2":"Add bell peppers, carrots, onion, water and the remaining ¼ teaspoon salt to the pan. Cook, stirring often, until the vegetables are crisp-tender, about 5 minutes.",
    ...
    {"0":"Bring a large pot of water to a boil. Add spaghetti and cook 2 minutes less than package directions.",
    ...
    {"0":"Heat 2 teaspoons oil in a large saucepan or Dutch oven over medium-high heat. Add carrot (or bell pepper) and chicken; cook, turning the chicken and stirring frequently, until the chicken begins to brown, 3 to 4 minutes.",
     "1":"Add garlic and cook, stirring, for 1 minute more. Stir in broth and marjoram; bring to a boil over high heat. Reduce the heat and simmer, stirring occasionally, until the chicken is cooked through, about 5 minutes.",
    ...
    {"0":"Whisk scallion greens, tamari, mirin, oil, white sesame seeds, ginger and crushed red pepper, if using, in a medium bowl. Set aside 2 tablespoons of the sauce in a small bowl.",
     "1":"Add shrimp to the sauce in the medium bowl and gently toss to coat.",
    ...
    {"0":"Cook pasta in a large pot of boiling water until tender, 8 to 10 minutes. Drain, return to the pot and set aside.",
     "1":"Meanwhile, heat oil in a large skillet over medium heat. Add mushrooms and Brussels sprouts and cook, stirring often, until the mushrooms release their liquid, 8 to 10 minutes.",
     "2":"Add garlic and cook, stirring, until fragrant, about 1 minute. Add sherry (or vinegar), scraping up any brown bits; bring to a boil and cook, stirring, until almost evaporated, 10 seconds (if using vinegar) or about 1 minute (if using sherry).",
    ...
    {"0":"Preheat oven to 425°F.",
     ...
     "3":"Meanwhile, whisk the remaining 4 tablespoons oil, ½ teaspoon salt and ¼ teaspoon pepper with vinegar, maple syrup and mustard in a large bowl. Set aside 2 tablespoons of the dressing.",
     "4":"Add arugula, cabbage and the squash to the large bowl and gently toss. Serve the salad topped with the salmon and drizzled with the reserved dressing.",
    ...
    {"0":"Place potatoes in a large saucepan and cover with 2 inches of water. Bring to a simmer over medium-high heat. Reduce heat to medium, partially cover and cook until tender, 10 to 15 minutes.",
     "1":"Drain and return the potatoes to the pot. Add buttermilk, butter and ¼ teaspoon each salt and pepper. Mash with a potato masher until mostly smooth.",
     ...
     "3":"Heat oil in a large skillet over medium-high heat. Add onion, carrot and water. Cover and cook, stirring occasionally, until softened, 3 to 5 minutes. Stir in corn, thyme and the remaining ½ teaspoon salt and ¼ teaspoon pepper; cook, stirring occasionally, for 2 minutes.",
    ...
    {"0":"Put the potatoes in a saucepan of cold salted water and bring to the boil. Reduce the heat to medium and simmer for 15-20 mins or until cooked but still firm.",
     ...
     "2":"Meanwhile, heat the oil in a large saucepan over a low-medium heat. Add the onion, celery, garlic, anchovy and chilli, season and cook for 8 mins or until softened.",
    ...
    {"0":"Place each chicken breast between 2 sheets of cling film or baking parchment. Use a meat mallet or rolling pin to bash each piece of chicken – flatten out to an even layer about 0.5cm thick. Transfer to a dish.",
     ...
     "2":"Stir through the lemon zest and juice, olive oil and some ground black pepper. Pour the marinade over the chicken, ensuring that it’s well coated. Cover and chill for at least 2 hrs.",
    ...
    {"0":"Make the marinade by mixing together all the ingredients. Drain the tofu by placing on several sheets of kitchen paper on a plate, with several more on top, and a heavy weight (such as a pan) on top of that. Leave for at least 15 mins. Cut the tofu into cubes and put in  a small bowl with the marinade. Cover and leave for 30 mins-1 hr.",
     ...
     "3":"In a frying pan or wok, heat the rapeseed and sesame oils over a high heat. Add the spring onion, garlic, chilli and ginger, and stir constantly for about 1 min.",
    ...
    {"0":"Dice the onion and mince the garlic. Cook both in a large pot with olive oil over medium heat for 1-2 minutes, or until soft and transparent.",
     "1":"Add the ground beef and continue to stir and cook until it is fully browned. If using a high fat ground beef, drain off the excessive after it is browned.",
